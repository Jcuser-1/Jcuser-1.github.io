...
| 页面模块 | 首页、简历详情页、经历时间轴（分类筛选 + Markdown）、项目作品集、关于、联系、搜索、404、固定导航（移动端折叠） |
...
| 基础体验 | 全站响应式、深浅色主题、回到顶部、面包屑、文章目录、阅读时长、代码块一键复制、平滑滚动、简历一键导出 PDF（打印样式）、登录页 SEO |
...
assets/css/style.css  全局样式（响应式 / 深浅色 / 打印）
assets/js/
